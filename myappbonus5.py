...
users.append([1, 'evan','code1',[0,0,200],[],0])
users.append([2, 'mar','code2',[200,200,0],[],0])
nmaparr=[]
green = [0,200,0]
black = [0,0,0]
red = [200,0,0]
...
def switch_turns():
    ...
    #return render_template('bonus_ships.html'),turn
...
#
                ...
                flash ('hit')
                g.user[5]+=1
                print ('to skore is',g.user[5])
                
                #g.message='Το σκορ του {} είναι {} και του {} είναι {}'.format(users[0][1],users[1][1],users[0][5],users[1][5])
                s.set_pixel(x,y,red)
                switch_turns()
                #flash ('είναι η σειρά σου') 
...
#         #nmaparr[x,y]=g.user[3]
        ...
        print(turn)
    g.message1='Είναι η σειρά του παίκτη',users[turn][1]
    return render_template('bonus_ships.html')
