...
users.append([2, 'mar','code2',[186,85,211],[]])
nmaparr=[]
green = [0,200,0]
black = [0,0,0]
red = [200,0,0]
    ...
    #except:
        ...
        #g.message1='Δεν είναι ακέραιος. Δοκίμασε ξανα'
            ...
            if x in range (0,8) and y in range (0,8):
                ...
                if (nmaparr[x,y]==[0,0,200]).all() or (nmaparr[x,y]==[186,85,211]).all() or (nmaparr[x,y]==[200,0,0]).all():
#     
                    g.message1='θεση κατειλημμένη'
                    print('besetzt')
#     
...
#
            ...
            g.message1='Δεν είναι ακέραιος. Δοκίμασε ξανα'   #g.message1='Δοκιμάστε ξανά'
    print(turn)
